...
public abstract class AbstractApiMethod {
    ...
    protected AbstractApiMethod(String methodGroupName, ObjectMapper objectMapper) {
    ...
    protected <T extends AbstractApiRequest, S> ApiRequestResult<S> makeRequest(RestHttpClient restHttpClient, String methodName, T request, Class<S> responseType) {
        ...
        try {
            ...
            try {
                apiRequestResult.setError(responseObjectMapper.readValue(responseEntity.getBody(), ErrorResponse.class).getError());
